...
def read_pkz(spin, run_name, grd_name, grd_acro):
    with open(f"/home/amazonfaceme/marcelagutierrez/novas_rodadas/CAETE-DVM-alloc-allom/outputs/{run_name}/{grd_name}/spin{spin:02d}.pkz", 'rb') as fh:
        dt = joblib.load(fh)
...
def pkz2csv(file, path, grd_name, run_name, spin_id, date_range, grd_acro) -> pd.DataFrame:
    ...
    CT1 = pd.read_csv("/home/amazonfaceme/marcelagutierrez/novas_rodadas/CAETE-DVM-alloc-allom/src/code_table_allom.csv")
    ...
    folder_path2 = f"/home/amazonfaceme/marcelagutierrez/novas_rodadas/CAETE-DVM-alloc-allom/outputs/{run_name}/{grd_name}/csv"
    ...
    # Verifique se o comprimento de area_TS é consistente com o índice idxT1
        ...
        dt1.to_csv(f"/home/amazonfaceme/marcelagutierrez/novas_rodadas/CAETE-DVM-alloc-allom/outputs/{run_name}/{grd_name}/csv/{csv_filename}", index=False)
