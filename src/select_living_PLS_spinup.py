...
run_name = 'MAN_save_spin_1'#input("What is the run name? ")
grd_name = '186-239'#input("The grid cell?lat-long ")
...
# 
print("Great!! Your file has been created! \n\nFind it in:", path_csv)
# 
# exclude files of PLSs csv for each spin
temp_files = os.listdir(path_csv)
# 
for file in temp_files:
    if file.startswith(f'{run_name}') and file.endswith('.csv'):
        print(file)
...
print('Now get the trait values from attrs (without considering the occupation)')
# Read file with all pls traits
pls_traits = pd.read_csv("/home/amazonfaceme/biancarius/CAETE-DVM-alloc-allom/outputs/baserun_6000pls_attrs_table/pls_attrs-6000.csv")
